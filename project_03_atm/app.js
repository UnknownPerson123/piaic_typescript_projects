...
async function repeat(message, type) {
    if (type !== "error") {
...
async function atmOptions() {
    const atmOptions = await createCLIInputs("list", "atm", "Which service you want to have.", ["Cash Withdraw", "Fast Cash", "Transfer Amount", "View Balance"]);
